...
public abstract class PageCodeBase {
	...
	protected void redirectPage(String pageName) {
		try	{
		    ExternalContext context = getFacesContext().getExternalContext(); 
		    context.redirect(context.getRequestContextPath()+ pageName);		
		} catch(Exception e) { e.printStackTrace(); }	
		
	}

	protected void addMessage(String message) {
		getFacesContext().addMessage(null, new javax.faces.application.FacesMessage(
		javax.faces.application.FacesMessage.SEVERITY_ERROR,message,message));		
	}
